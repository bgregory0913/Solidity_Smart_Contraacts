...
// Testing function to fast forward time:
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "Shares can't be distributed yet.");
        require(distributed_shares < total_shares, "No shares left for distribution.");
